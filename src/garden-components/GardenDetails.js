  ...
  return (
    <>
      <div className="flex  justify-center">
                  ...
                  <div className="flex items-center justify-between sm:mt-2">
                    <div className="flex flex-col">
                      ...
                      <div className="text-gray-500 my-1">
                        <span className="mr-3 tracking-tighter text-gray-600">{garden.gardenRestriction}</span>
                        <span className="mr-3 tracking-tighter border-r border-gray-600 max-h-0" />
                        <span className="tracking-tighter">{garden.gardenDescription}</span>
                      </div>
                    </div>
                  </div>
        ...
        <div className="flex justify-start items-center">  {canjoin===true &&  <Join address={address} />}</div>
